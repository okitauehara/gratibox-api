...
export default async function postSignature(req, res) {
  ...
  try {
    ...
    products.forEach(async (product) => {
      await connection.query('INSERT INTO users_products (user_id, product_id) VALUES ($1, $2)', [userId, Number(product)]);
    });
    ...
    await connection.query('INSERT INTO signatures (user_id, plan_id, delivery_id) VALUES ($1, $2, $3)', [userId, planId, deliveryInfosId]);
